    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto"  data-toggle="modal" data-target="#myModal">Login</a></li>
          <li><a class="getstarted scrollto"  data-toggle="modal" data-target="#myModal2">Get Admision</a></li>
        </ul>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              ...
              <input type="text" id="fname" name="guardian name">
              <label for="fname">Email ID</label>
              <input type="email" id="fname" name="email">
              <label for="fname">Contact Number</label>
              <input type="text" id="fname" name="ph" min=10 max=10>
              <label for="fname">House Name</label>
              <input type="text" id="fname" name="house">
              ...
              <input type="text" id="fname" name="district">
              <label for="fname">ID proof</label>
              <input type="file" id="fname" name="id">
              <label for="fname">Profile Picture</label>
              <input type="text" id="fname" name="pic">
